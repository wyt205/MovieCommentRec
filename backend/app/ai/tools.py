...
# 注意：绝不能放裸「别」——它会被「特别/级别/区别/别人」等常见词误伤，
# 导致「想看部特别刺激的动作片」里的「刺激→动作」抽不出来（用户实测 G01 用例失败根因）。
# 只用「别 + 动词」这类明确否定搭配，或完整否定短语。
_NEGATION_WORDS = ["不要", "非", "不是", "除了", "排除", "不想要", "不想看",
                   "别推荐", "别给", "别推", "别带", "别弄", "别来", "别是", "别加", "别上"]
